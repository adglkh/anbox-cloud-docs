...
> If you plan to autoscale LXD cluster, first assign the `control-plane` role to a fixed set of members that should never be scaled down. See {ref}`howto-cluster-manage-control-plane` for details.
